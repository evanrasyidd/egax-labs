  ...
  const projects = [
    {
      ...
      category: 'project',
      type: 'web',
      thumbnail: '/projects/rasgaa.webp',
    ...
    },
    {
      ...
      category: 'project',
      type: 'e-commerce',
      thumbnail: '/projects/egax-studiosss.webp',
    ...
    },
    {
      ...
      category: 'project',
      type: 'pwa',
      thumbnail: '/projects/invoicegua.webp',
    ...
    },
    {
      ...
      category: 'project',
      type: 'web',
      thumbnail: '/projects/egalog.webp',
    ...
    {
      title: 'EgaxDev Portfolio',
      slug: 'egaxdev',
      description: 'Portfolio single-page: hero 3D physics dengan live GitHub activity, project cards physics-tilt, dan contact form via Supabase.',
      longDesc: 'Versi ringkas dari portfolio utama, sengaja cuma 3 section: Hero, Work, dan Contact. Hero punya 3D physics badge (React Three Fiber + Rapier) yang nampilin live GitHub activity, project cards punya physics-tilt yang ngikutin cursor, dan contact form nyimpen pesan ke Supabase tanpa perlu email.\n\nDark/light mode pake circular reveal via View Transitions API, bilingual EN/ID, dan smooth scroll native compositor-driven tanpa library JS.',
      techStack: 'Next.js,TypeScript,TailwindCSS,Framer Motion,React Three Fiber,Rapier,react-hook-form,Zod',
      category: 'project',
      type: 'personal',
      thumbnail: '/projects/egaxdev.webp',
      demoUrl: 'https://egaxdev.vercel.app',
      repoUrl: null,
      featured: false,
      sort: 5,
    },
    {
      title: 'evanrasyidd Portfolio',
      slug: 'evanrasyidd',
      description: 'Portfolio scroll-heavy dengan animasi GSAP: SplitText, scramble text, ScrollTrigger, dan smooth scroll Lenis.',
      longDesc: 'Portfolio satu halaman yang scroll-nya dikoreografi penuh: teks di-reveal per karakter pake SplitText, efek scramble pake ScrambleTextPlugin, easing custom pake CustomEase, dan tiap section disinkronin ke ScrollTrigger. Lenis ngatur smooth scroll dan disinkronkan langsung ke ScrollTrigger biar animasinya gak patah-patah.\n\nBilingual EN/ID dengan Zustand, tema dark/light, dan static export ke Vercel.',
      techStack: 'Next.js,TypeScript,TailwindCSS,GSAP,Lenis,Zustand',
      category: 'project',
      type: 'personal',
      thumbnail: '/projects/evanrasyidd.webp',
      demoUrl: 'https://evanrasyidd.vercel.app',
      repoUrl: null,
      featured: false,
      sort: 6,
    },
